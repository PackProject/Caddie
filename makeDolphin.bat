...
python make.py --region NTSC_J --flags=%1
goto copy

:standard
python make.py --region NTSC_U
python make.py --region PAL
python make.py --region NTSC_J
...
xcopy "build/modules/Caddie_PAL.map" "romfs/PAL/files/modules/main_PAL.map" /y /f /i

xcopy "build/main_NTSC_J.dol" "romfs/NTSC_J/sys/main.dol" /y /f /i
xcopy "build/modules/Caddie_NTSC_J.bin" "romfs/NTSC_J/files/modules/main_NTSC_J.bin" /y /f /i
xcopy "build/modules/Caddie_NTSC_J.map" "romfs/NTSC_J/files/modules/main_NTSC_J.map" /y /f /i
