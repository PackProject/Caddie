...
xcopy "build/main_NTSC_J.dol" "riivo/caddie/sys/main_NTSC_J.dol" /y /f /i
xcopy "build/modules/Caddie_NTSC_J.bin" "riivo/caddie/files/modules/main_NTSC_J.bin" /y /f /i