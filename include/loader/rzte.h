...
const u32 CADDIE_ENTRYPOINT = 0x8022e2c0;
#elif CADDIE_REGION_PAL
const u32 CADDIE_ENTRYPOINT = 0x8022e538;
...
const loaderFunctionsEx cFunctionsNTSC_U = {
    {(OSReport_t)0x80061470, (OSFatal_t)0x800493a0,
     (DVDConvertPathToEntrynum_t)0x8009a620, (DVDFastOpen_t)0x8009a930,
     (DVDReadPrio_t)0x8009af50, (DVDClose_t)0x8009ac60, (sprintf_t)0x8000d168,
     allocAdapter, freeAdapter},
