...
CADDIE_LOCALIZE(kmCall(0x8022e2d4, Exception::InitConsole), // NTSC_U
                kmCall(0x8022e54c, Exception::InitConsole), // PAL
                kmCall(0x8022e2d4, Exception::InitConsole), // NTSC_J
